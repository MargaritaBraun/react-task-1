...
describe('проверка на наличие TopSection', () => {
    ...
    beforeEach(() => {
        render(<TopSection onInputChange={testonInputChange} onClick={testonClick} searchValue={testsearchValue} />)
    })

    it('должен отображать заголовок', () => {
        const heading: HTMLHeadingElement = screen.getByText(/you can find a book/i);
